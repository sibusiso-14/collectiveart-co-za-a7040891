  ...
  head: () => ({
    meta: [
      { title: "Designers — Collaborate.art" },
      {
        name: "description",
        content:
          "The independent ateliers on Collaborate.art: destroyed skatewear from Damnation Designs and fur, denim and outerwear from Galbakaline.",
      },
